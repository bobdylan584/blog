...
- **二值图像**
  ...
  ![1755689633198](1755689633198.png)
...
- **索引图像**
  ...
  ![1755689642971](1755689642971.png)
...
- **真彩色RGB图像**
  ...
  ![1755689790662](1755689790662.png)

  ![1755689804624](1755689804624.png)
...
| **RGB图像**  | 3通道（R、G、B） | 0 到 255         | 每个像素由红、绿、蓝三个通道组成         | 普通彩色图像显示、图像处理与分析 |
  ...
  ![1755689839501](1755689839501.png)
...
![1755689851639](1755689851639.png)
...
![1755689859599](1755689859599.png)
...
![1755689873488](1755689873488.png)
...
![1755689889238](1755689889238.png)
...
![1755689952791](1755689952791.png)
...
![1755689966517](1755689966517.png)

如果把Stride增大为2，也是可以提取特征图的，如下图所示：

![1755689973014](1755689973014.png)

### 3.4 多通道卷积计算

实际中的图像都是多个通道组成的，我们怎么计算卷积呢？

![1755689982891](1755689982891.png)
...
![1755689992907](1755689992907.png)
...
![1755690006300](1755690006300.png)

通过以下例子查看多卷积核卷积计算流程:

![1755690015755](1755690015755.png)
...
![1755690031178](1755690031178.png)
...
![1755690038311](1755690038311.png)
...
![1755690048786](1755690048786.png)
...
![1755690060555](1755690060555.png)
...
- 最大池化(Max Pooling) ：通过池化窗口进行最大池化，**取窗口中的最大值作为输出**
  ...
  ![1755690081211](1755690081211.png)

- 平均池化(Avg Pooling) ：**取窗口内的所有值的均值作为输出**

  ![1755690089866](1755690089866.png)

### 4.2 Padding（填充）

![1755690102727](1755690102727.png)

### 4.3 Stride（步长）

![1755690113060](1755690113060.png)
...
![1755690125462](1755690125462.png)
...
![1755690139198](1755690139198.png)
...
![1755690154879](1755690154879.png)

### 5.2 搭建图像分类网络

搭建的CNN网络结构如下:

![1755690165308](1755690165308.png)
...
![1755690179575](1755690179575.png)
