---
date: 2023-05-26 18:44:06
title: 神经网络基础
categories: [AI_Module, DeepLearning, 神经网络基础]
tag: AI_Module
---
...
![](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com/DeepLearning/ANN/05.png)
...
![](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com/DeepLearning/ANN/08.png)
...
![](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com/DeepLearning/ANN/07.png)
...
<img src="https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/image-20220313130303542.png" alt="image-20220313130303542" style="zoom:40%;" />
...
![](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com/DeepLearning/ANN/09.png)
![](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com/DeepLearning/ANN/10.png)
...
![](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com/DeepLearning/ANN/11.png)
...
![](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com/DeepLearning/ANN/21.png)

激活函数求导公式：

![1663472645904](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/1663472645904.png)

sigmoid 激活函数的函数图像如下:

![](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com/DeepLearning/ANN/25.png)
...
![](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com/DeepLearning/ANN/23.png)

激活函数求导公式: 

![1663472675509](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/1663472675509.png)

Tanh的函数图像、导数图像如下：

![](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com/DeepLearning/ANN/24.png)
...
![](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com/DeepLearning/ANN/26.png)

激活函数求导公式: 

![1663472703595](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/1663472703595.png)

ReLU 的函数图像、导数图像如下：

![](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com/DeepLearning/ANN/1734057447434.png)
...
![](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com/DeepLearning/ANN/29.png)

![](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com/DeepLearning/ANN/30.png)
...
>
> ![](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com/DeepLearning/ANN/31.png)
...
<img src="https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/image-20220313133601678.png" alt="image-20220313133601678" style="zoom:50%;" />
...
- 模型参数的计算
  ...
  - 输入数据和网络权重是两个不同的事儿！对于初学者理解这一点十分重要，要分得清。
    ...
    <img src="https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/image-20220313141138281.png" alt="image-20220313141138281" style="zoom:40%;" />
...
![image-20200730153842351](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/03-1.png)

损失函数在不同的文献中名称是不一样的，主要有以下几种**命名方式**：

<img src="https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/03-2.png" alt="image-20200730154850183" style="zoom:50%;" />
...
<img src="https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/03-3.png" alt="image-20200730161303768" style="zoom:50%;" />
...
<img src="https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/03-4.png" alt="image-20200730160805389" style="zoom: 67%;" />

上图中的交叉熵损失为：

![image-20200730161024749](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/03-5.png)

从概率角度理解，我们的目的是最小化正确类别所对应的预测概率的对数的负值(损失值最小)，如下图所示：

<img src="https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/03-6.png" alt="image-20200730161746110" style="zoom:67%;" />
...
![image-20200730162332710](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/03-7.png)
...
- L用来衡量真实值y与预测值$$\hat{y}$$之间差异性的损失结果。
  ...
  <img src="https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/1735117379356.png" style="zoom:67%;" />
...
![image-20200730165058491](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/03-8.png)

曲线如下图所示：

![image-20200730165142553](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/03-9.png)
...
![image-20200730165213969](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/03-10.png)

曲线如下图所示：

![image-20200730165404271](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/03-11.png)
...
![image-20200730170635889](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/03-12.png)

其中：`𝑥=f(x)−y` 为真实值和预测值的差值。

<img src="https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/03-13.png"  style="zoom:50%;" />
...
![](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com/DeepLearning/ANN/12.png)

其中，η是学习率，如果学习率**太小**，那么每次训练之后得到的效果都太小，**增大训练的时间成本**。如果，学习率**太大**，那就有可能**直接跳过最优解**，进入无限的训练中。解决的方法就是，学习率也需要随着训练的进行而变化。

![](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com/DeepLearning/ANN/04-05.png)
...
![](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/13.png)
...
![](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com/DeepLearning/ANN/14.png)
...
<img src="https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/image-20210129103846076.png" alt="image-20210129103846076" style="zoom:50%;" />

**前向传播运算**：

<img src="https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/image-20210129104612230.png" alt="image-20210129104612230" style="zoom:70%;" />
...
<img src="https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/image-20210129104646474.png" alt="image-20210129104646474" style="zoom:70%;" />

导数（梯度）已经计算出来了，下面就是**反向传播与参数更新过程**：

<img src="https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/image-20210129104718140.png" alt="image-20210129104718140" style="zoom:70%;" />

如果要想求**误差E对w1的导数**，误差E对w1的求导路径不止一条，这会稍微复杂一点，但换汤不换药，计算过程如下所示：

<img src="https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/image-20210129104756053.png" alt="image-20210129104756053" style="zoom:70%;" />
...
![](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com/DeepLearning/ANN/50.png)
...
![](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com/DeepLearning/ANN/37.png)
...
![1735177998337](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/1735177998337.png)
...
![1734144867552](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/1734144867552.png)
...
![](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com/DeepLearning/ANN/42.png)
...
![image-20220313172050673](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/04-01.png)

###  等间隔学习率衰减

等间隔学习率衰减方式如下所示：

<img src="https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/04-02.png" alt="image-20220313172716591" style="zoom: 50%;" />
...
<img src="https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/04-03.png" alt="image-20220313172915819" style="zoom: 50%;" />
...
<img src="https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/04-04.png" alt="image-20220313173110595" style="zoom: 50%;" />
...
![05-01](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/05-01.png)
...
![image-20220517141847967](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/image-20220517141847967.png)
...
![image-20220517143935599](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/image-20220517143935599.png)

先对数据标准化，再对数据重构（缩放+平移），写成公式如下所示：

![](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com/DeepLearning/ANN/48.png)
...
![1734255905857](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/1734255905857.png)
...
![1734256199295](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/1734256199295.png)
...
![1734256384162](https://bob-blog-image.oss-cn-shanghai.aliyuncs.com//DeepLearning/ANN/1734256384162.png)
